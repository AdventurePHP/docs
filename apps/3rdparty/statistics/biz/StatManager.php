<?php
   ...
   class StatManager extends APFObject {
       ...
       * @var string The user agent for this request.
       */
      ...
      function getOS() {
         ...
         foreach($osTable as $key => $value) {
            if(substr_count($this->getUserAgent(),$key) > 0) {
               $os = $value;
               // end if
            }
            // end foreach
       ...
       *
       * @return string The corresponding browser string or the plain user agent.
       *
       * @author Christian Achatz
       * @version
       * Version 0.1, 22.12.2005<br />
      ...
      /**
       * @return string The cached user agent of the current request.
       */
